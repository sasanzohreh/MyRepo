...
class Drawing extends DrawingCommon {
    ...
    texFiles: (string | THREE.Texture)[] = [ "../assets/explosion.jpg", "../assets/brick_diffuse.jpg", "../assets/water.jpg", "../assets/brick_diffuse.jpg" ];
    ...
    uniforms: { [uniform: string]: THREE.IUniform }[] = [
        {
            ...
            u_count: {value: Math.floor(num!.valueAsNumber * 20) + 5},
            u_time: {value: 0.0},
            u_iteration: {value: Math.floor(num!.valueAsNumber * 200) + 20}
        },
        {
            u_ambient: {value: new THREE.Color( num!.valueAsNumber, num!.valueAsNumber, num!.valueAsNumber)},
            u_color: {value: new THREE.Color( 0xdd2200 )},
            u_colorTexture: {value: null},
            u_radius: {value: num!.valueAsNumber/5}
        },
        {
            u_ambient: {value: new THREE.Color( num!.valueAsNumber, num!.valueAsNumber, num!.valueAsNumber)},
            u_color: {value: new THREE.Color( 0xdd2200 )},
        ...
        },
        {
            ...
            u_color: {value: new THREE.Color( 0xdd2200 )},
            u_colorTexture: {value: null},
            u_colorImage: {value: null},
            u_threshold: {value: num!.valueAsNumber}
        }
    ];
    ...
    finishSetup() {
        this.uniforms[1].u_colorTexture.value = this.texFiles[1] as THREE.Texture;
        this.uniforms[1].u_colorTexture.value.wrapS = this.uniforms[1].u_colorTexture.value.wrapT = THREE.RepeatWrapping;
        this.uniforms[2].u_colorTexture.value = this.texFiles[2] as THREE.Texture;
        this.uniforms[2].u_colorTexture.value.wrapS = this.uniforms[2].u_colorTexture.value.wrapT = THREE.RepeatWrapping;
        this.uniforms[3].u_colorTexture.value = this.texFiles[3] as THREE.Texture;
        this.uniforms[3].u_colorTexture.value.wrapS = this.uniforms[3].u_colorTexture.value.wrapT = THREE.RepeatWrapping;
        this.uniforms[3].u_colorImage.value = this.texFiles[0] as THREE.Texture;
        this.uniforms[3].u_colorImage.value.wrapS = this.uniforms[3].u_colorImage.value.wrapT = THREE.RepeatWrapping;
	...
	*/
	updateScene(time: DOMHighResTimeStamp){
        ...
        switch (this.programNumber) {
          case 0:
            this.uniforms[0].u_count.value = Math.floor(num!.valueAsNumber * 20) + 5;
            this.uniforms[0].u_time.value = time;
            this.uniforms[0].u_iteration.value = Math.floor(num!.valueAsNumber * 200) + 20;
          ...
          case 1:
            ...
            this.uniforms[1].u_radius.value = num!.valueAsNumber/5;
            break;
          ...
          case 3:
            ...
            this.uniforms[3].u_threshold.value =  num!.valueAsNumber;
            break;
        }
    }
