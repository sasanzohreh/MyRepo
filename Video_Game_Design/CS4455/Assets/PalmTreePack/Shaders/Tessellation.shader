	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv_Albedo = inputMesh.ase_texcoord.xy * _Albedo_ST.xy + _Albedo_ST.zw;
				float4 tex2DNode13 = tex2Dlod( _Albedo, float4( uv_Albedo, 0, 0.0) );
				float3 temp_cast_0 = (( tex2DNode13.a * _Displacement )).xxx;
						...
						)
			{
				...
				surfaceDescription.Normal = tex2D( _Normal, uv_Normal ).rgb;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 uv_Albedo = inputMesh.uv0.xy * _Albedo_ST.xy + _Albedo_ST.zw;
				float4 tex2DNode13 = tex2Dlod( _Albedo, float4( uv_Albedo, 0, 0.0) );
				float3 temp_cast_0 = (( tex2DNode13.a * _Displacement )).xxx;
...
/*ASEBEGIN
Version=18934
0;16;786;495;647.7591;143.0242;1;True;False
Node;AmplifyShaderEditor.SamplerNode;13;-803.7124,-250.8414;Inherit;True;Property;_Albedo;Albedo;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;17;-547.3381,751.1843;Inherit;False;Property;_Displacement;Displacement;0;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-211.3552,328.8782;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-776.7753,301.8053;Inherit;True;Property;_Normal;Normal;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;15;-749.5104,56.59619;Inherit;False;Property;_Smoothness;Smoothness;1;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-352.1195,18.76331;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;1;11;18;0
ASEEND*/
//CHKSM=5AC2DCBACA2A3CCFD70CFF7651437BBCCAD1946A